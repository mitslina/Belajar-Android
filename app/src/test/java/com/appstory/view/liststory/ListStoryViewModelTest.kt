...
import com.appstory.DataDummy
import com.appstory.MainDispatcherRule
import com.appstory.data.network.respons.ListStoryItem
import com.appstory.getOrAwaitValue
...
class ListStoryViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<ListStoryItem> = listStoryViewModel.story.getOrAwaitValue()
